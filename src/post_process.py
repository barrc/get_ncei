...
if __name__ == '__main__':
    ...
    isd_stations = common.get_stations('isd_herewegoagain.csv')
        ...
        if out_data:
            ...
            if any(x < 0 for x in xs):
                ...
                if matching_station:
                    if matching_station[0].in_basins and not matching_station[0].break_with_basins:
                        if matching_station[0].network == 'coop':
                            ...
                            matching_station[0].station_id[-6:]]
                ...
                if length_of_record < 10:
                    ...
                    annual_precip = sum(list(out_data.values()))/length_of_record
    ...
    # TODO modify
    with open('D4EM_PREC_updated.txt', 'w') as file:
